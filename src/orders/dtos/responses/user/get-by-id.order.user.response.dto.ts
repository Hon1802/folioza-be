...
export class OrderDetailUserResponseDto extends BaseMapperDto {
  @AutoMapDecorator()
  id: number;
...
export class GetByIdOrderUserResponseDto extends BaseMapperDto {
  @AutoMapDecorator()
  id: number;
  ...
  @NestedArrayDecorator(() => OrderDetailUserResponseDto)
  orderDetails?: OrderDetailUserResponseDto[] | null;
